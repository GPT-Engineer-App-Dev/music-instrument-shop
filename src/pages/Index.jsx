  ...
  return (
    <Box>
      ...
      <Box bg="gray.200" color="white" textAlign="center" py={20}>
        ...
        <Text fontSize="xl" mb={4">Find the perfect instrument for you</Text>
      ...
      <Container maxW="container.xl" py={20}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
          <Box as="article" textAlign="center">
            <Image src="https://via.placeholder.com/150" alt="Product 1" mx="auto" mb={4} />
            <Heading size="md" mb={2}>Product 1</Heading>
            <Text>$200</Text>
          </Box>
          <Box as="article" textAlign="center">
            <Image src="https://via.placeholder.com/150" alt="Product 2" mx="auto" mb={4} />
            <Heading size="md" mb={2}>Product 2</Heading>
            <Text>$250</Text>
          </Box>
          <Box as="article" textAlign="center">
            <Image src="https://via.placeholder.com/150" alt="Product 3" mx="auto" mb={4} />
      ...
      {/* Footer */}
      <Box as="footer" bg="gray.800" color="white" py={10} mt="auto">
        <Container maxW="container.xl">
          ...
          <Text mt={4}>123 Music Street, New York, NY 10001</Text>
